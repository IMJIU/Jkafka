...
//    List configs = Lists.newArrayList(new KafkaConfig(Sc.head(TestUtils.createBrokerConfigs(1, false))));
//    String zookeeperConnect = TestZKUtils.zookeeperConnect;
//
//    @Test
//   public void testReachableServer() {
//        KafkaServer server = Sc.head(servers);
//        Properties props = TestUtils.getSyncProducerConfig(server.socketServer.port);
//
...
//        } catch {
//            case SocketTimeoutException e -> /* success */
//            case Throwable e -> Assert.fail("Unexpected exception when expecting timeout: " + e);
//        }
