...
//
//    Map<Tuple<String, Integer>, List<Integer>> topicPartitionIsr = new HashMap<>();
...
//    privatepublic
//
//    void getPartitionWithAllReplicasInIsr(String topic, Integer partitionId, Time time, KafkaConfig config,
...
//    }
//
//    private Log getLogWithLogEndOffset(Long logEndOffset, Integer expectedCalls) {
//        Log log1 = EasyMock.createMock(kafka.log.Log.class);
...
//    privatepublic
//
//    void getFollowerReplicas(Partition partition, Integer leaderId, Time time):Seq<Replica> =
//
//    {
//        configs.filter(_.brokerId != leaderId).map {
//        config ->
