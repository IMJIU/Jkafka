...
public OffsetManagerConfig config;
    ...
    public OffsetManagerConfig(OffsetManagerConfig config, ReplicaManager replicaManager, ZkClient zkClient, Scheduler scheduler) {
        this.config = config;
  ...
  /* offsets and metadata cache */
       ...
       public Integer  void partitionFor(String group) Utils.abs(group.hashCode) % config.offsetsTopicNumPartitions;
         ...
         */
        private  void getOffset(GroupTopicPartition key) = {
   ...
   public void loadOffsetsFromLog(Int offsetsPartition) {
    ...
    private  Long  void getHighWatermark(Int partitionId) {
    ...
    private  void leaderIsLocal(Int partition) = { getHighWatermark(partition) != -1L }
...
private  void schemaFor(Int version) = {
