...
//   * each partition. */
//        private var Integer controllerEpoch = KafkaController.InitialControllerEpoch - 1;
//        this.logIdent = String.format("Partition <%s,%d> on broker %d: ",topic, partitionId, localBrokerId)
//
//        private public Boolean  void  isReplicaLocal Integer replicaId)  (replicaId == localBrokerId);
//
...
//  );
//
//        public Boolean  void  isUnderReplicated() {
...
//  }
//
//            public Replica  void  getOrCreateReplica Integer replicaId = localBrokerId) {
...
//        }
//
//        public void  assignedReplicas(): Set<Replica> = {
...
//         */
//        public void  makeLeader Integer controllerId,
...
//         */
//        public void  makeFollower Integer controllerId,
//                PartitionStateInfo partitionStateInfo,
//                Integer correlationId, OffsetManager offsetManager): Boolean = {
//                inWriteLock(leaderIsrUpdateLock) {
//                val allReplicas = partitionStateInfo.allReplicas;
//                val leaderIsrAndControllerEpoch = partitionStateInfo.leaderIsrAndControllerEpoch;
//                val leaderAndIsr = leaderIsrAndControllerEpoch.leaderAndIsr;
...
//         * @param leaderReplica
//         */
//    private public void  maybeIncrementLeaderHW(Replica leaderReplica) {
...
//    }
//
//    public void  appendMessagesToLeader(ByteBufferMessageSet messages, Integer requiredAcks=0) = {
...
//    }
//
//    private public void  updateIsr(Set newIsr<Replica>) {
...
//    }
//
//    override public Boolean  void  equals(Any that) {
...
//    }
//
//    override public Integer  void  hashCode() {
//        31 + topic.hashCode() + 17*partitionId;
//    }
//
//    override public String  void  toString() {
